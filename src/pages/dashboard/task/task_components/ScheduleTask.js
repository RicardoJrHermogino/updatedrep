...
const ScheduleTask = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    const userId = "exampleUserId"; // Replace with the actual user ID from your auth system
    ...
    try {
      const response = await fetch('http://localhost:3000/api/tasks', { // Make sure the port matches your Next.js app
        method: 'POST',
        headers: {
